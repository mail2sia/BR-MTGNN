...
def is_global_column(col: str, global_regex: str = "") -> bool:
    c = str(col).strip()
    low = c.lower()
    prefixes = ("global_", "global", "g_", "exo_", "cov_", "context_")
...
class RMDPTData:
    ...
    def _split_windows(self):
        ...
        valid = TensorDataset(
            self.X[train_n:train_n + valid_n],
            self.Y[train_n:train_n + valid_n],
            self.M_nom[train_n:train_n + valid_n],
            self.M_nop[train_n:train_n + valid_n],
            self.M_pt[train_n:train_n + valid_n],
        )
        test = TensorDataset(
            self.X[train_n + valid_n:],
            self.Y[train_n + valid_n:],
            self.M_nom[train_n + valid_n:],
            self.M_nop[train_n + valid_n:],
            self.M_pt[train_n + valid_n:],
        )
